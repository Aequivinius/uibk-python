...
def create_city_dict(path):
    ...
    # print("Before filter: ", cities["University"])
    ...
    # print("After filter: ", cities["University"])
    # print(cities)
    return cities

def main(haystack, needles, output):
    """ Finds specific words (needles) in large text (haystack). Then returns the resulting occurrences in a new file (output).
