...
print("First character of short string:", short_string[0])
print("Third character of short string: " + short_string[2])
long_string_length = len(long_string)
print("Last character of long string: " + long_string[long_string_length - 1])
print("Or simpler: " + long_string[-1])
print("Likewise, the 5th last character: " + long_string[-5], "\n")
#print("\n")

# We can use this notation to extract substrings
print("2nd up to and including 4th character " + number_string[1:4])
print("5th last character to 2nd last: " + number_string[-5:-2])
print("Last 5 characters: " + number_string[-5:])
print("\n")
